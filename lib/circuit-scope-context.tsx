...
import { getCircuits, getCircuitById } from '@/lib/diocese-circuit-storage';
...
export function useCircuitScope(): { circuitId: string | null; circuit: ReturnType<typeof getCircuitById> } {
